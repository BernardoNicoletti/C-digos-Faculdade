...
algoritmo que leia o número de horas trabalhadas em um mês, o valor por hora e escreva o salário total do funcionário, 
...
public class Uni4Exe01 {
    public static void main(String[] args) {
        ...
        double valorHora, horasTrabalhadas, salarioTotal, acrescimoSalario;
        horasTrabalhadas = teclado.nextDouble();
        valorHora = teclado.nextDouble();
        salarioTotal = horasTrabalhadas * valorHora;
        if (horasTrabalhadas > 160) {
            acrescimoSalario = (horasTrabalhadas - 160) * (valorHora / 2);
            salarioTotal = salarioTotal + acrescimoSalario;
        } else {
